...
class CatatanPribadiPage extends StatefulWidget {
  const CatatanPribadiPage({Key? key}) : super(key: key);
  ...
  void addNote() {
    ...
    setState(() {
      notes.insert(0, {
        ...
        'date': DateTime.now().day.toString() + " Mei 2026",
      });
    });
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              // const Text(
                              //   "Ya Allah, lindungi keluargaku dan berikan kebahagiaan dunia akhirat.",
                              //   style: TextStyle(
