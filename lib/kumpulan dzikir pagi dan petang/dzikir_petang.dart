      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xff181D27), Color(0xff232A36), Color(0xff2C3443)],
            ...
            children: [
              ...
              buildDzikirCard(
                ...
                arab:
                    ...
                    "رَبِّ أَسْأَلُكَ خَيْرَ مَا فِيْ هَذِهِ اللَّيْلَةِ وَخَيْرَ مَا بَعْدَهَا، "
                ...
                latin:
                    "Amsainaa wa amsal mulku lillah walhamdulillah,\n"
                    "laa ilaha illallah wahdahu laa syarika lah,\n"
                    "lahul mulku walahul hamdu wa huwa ‘ala kulli syai-in qodir.\n"
                    "Robbi as-aluka khoiro maa fii haadzihil lailah wa khoiro maa ba’dahaa,\n"
                    "wa a’udzu bika min syarri maa fii haadzihil lailah wa syarri maa ba’dahaa.\n"
                    "Robbi a’udzu bika minal kasali wa suu-il kibar.\n"
                    "Robbi a’udzu bika min ‘adzaabin fin naari wa ‘adzaabin fil qobri.",
                arti:
                    ...
                    "Wahai Rabbku, aku mohon kepada-Mu kebaikan malam ini dan kebaikan sesudahnya. "
                    "Aku berlindung kepada-Mu dari kejahatan malam ini dan kejahatan sesudahnya. "
              ...
              // Dzikir 9
              buildDzikirCard(
                title: "Dzikir Petang: Amsainaa ‘ala Fithratil Islam",
                arab:
                ...
                latin:
                    "Amsainaa ‘ala fithrotil islaam wa ‘alaa kalimatil ikhlaash,\n"
                ...
                arti:
                    "Di waktu petang kami memegang agama Islam, kalimat ikhlas (kalimat syahadat), "
              ...
              // Dzikir 12
              buildDzikirCard(
                title: "Dzikir Petang: A'udzu Bikalimatillahit Taammati",
                arab:
              ...
              const Center(
                child: Text(
                  "Semoga Allah memberikan keberkahan di petang hari 🌙",
